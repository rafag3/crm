...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  ...
  },
  {
    id: "emerald",
    name: "Esmeralda",
    tagline: "Transmite crescimento, sem copiar o verde do WhatsApp.",
  ...
  },
  {
    id: "amber",
    name: "Âmbar",
    tagline: "Quente e amigável — ótimo para equipes pequenas.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Arrojado e moderno — D2C e lifestyle.",
